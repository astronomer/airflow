...
class AbstractDagImporter(ABC):
    ...
    DAG importers parse files in a specific format and produce DAG objects.
    Each importer handles one or more file extensions.
    """
...
class DagImporterRegistry:
    ...
    Singleton that manages importers and provides lookup by file extension.
    """
