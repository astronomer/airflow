...
import type { DAGRunClearBody, TaskInstanceOffsetCollectionResponse } from "openapi/requests/types.gen";
...
export const useClearDagRunDryRun = <TData = TaskInstanceOffsetCollectionResponse, TError = unknown>({
  dagId,
  dagRunId,
  options,
  requestBody,
