...
export class PartitionedDagRunService {
     ...
     * @throws ApiError
     */
    public static getPartitionedDagRun(data: GetPartitionedDagRunData): CancelablePromise<GetPartitionedDagRunResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/ui/partitioned_dag_runs/{dag_id}/{partition_key}',
            path: {
                dag_id: data.dagId,
