...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    def test_task_group_setup_teardown_tasks(self):
        ...
        def _check_taskgroup_children(se_task_group, dag_task_group, expected_children):
            assert se_task_group.children.keys() == expected_children
            assert dag_task_group.children.keys() == expected_children

        _check_taskgroup_children(serialized_dag.task_group, dag.task_group, {"setup", "teardown", "group1"})
    ...
    def test_task_group_setup_teardown_taskgroups(self):
        ...
        _check_taskgroup_children(se_sub_setup_group, dag_sub_setup_group, {"setup_group.sub_setup.setup2"})
        ...
        _check_taskgroup_children(se_teardown_group, dag_teardown_group, {"teardown_group.teardown1"})
