...
type DataProductsPluginProps = {
  readonly customConfig?: Record<string, unknown>;
  readonly dagId?: string;
  readonly taskId?: string;
};

export const DataProductsPlugin = ({ customConfig, dagId, taskId }: DataProductsPluginProps) => {
  ...
  return (
    <ChakraProvider value={system}>
      <DataProductsPage dagId={dagId} taskId={taskId} />
    </ChakraProvider>
  );
};

// Register as global for Airflow plugin system
(globalThis as Record<string, unknown>).AirflowPlugin = DataProductsPlugin;

export default DataProductsPlugin;
