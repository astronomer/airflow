...
(supervisor-side) and provider-registered bridges such as the runtime
coordinator (child-side) use these building blocks to multiplex
...
def make_raw_forwarder(
    ...
    msgpack frames between a supervisor and a runtime subprocess).
    """
