...
func NewWorker(
	...
	concurrency.FromWorkerStateBodySysinfo1(edgeapi.WorkerStateBodySysinfo1(0))
...
func (w *worker) fetchJob(ctx context.Context) (*bundlev1.ExecuteTaskWorkload, int32, error) {
	...
	w.logger.Debug("Asking for work", "freeConcurrency", free, "max", w.maxConcurrency)
...
func (w *worker) runWorkload(
	...
	w.logger.Info("runWorkload", "payload", fmt.Sprintf("%#v\n", workload))
