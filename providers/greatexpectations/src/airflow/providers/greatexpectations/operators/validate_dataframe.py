...
from airflow.providers.greatexpectations.exceptions.exceptions import (
...
class GXValidateDataFrameOperator(BaseOperator):
    ...
    :param configure_dataframe: A callable which returns the DataFrame to be validated.
    :param expect: An Expectation or ExpectationSuite to validate against the DataFrame. Available Expectations can
