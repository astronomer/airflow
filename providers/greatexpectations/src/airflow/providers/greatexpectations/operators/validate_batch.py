...
class GXValidateBatchOperator(BaseOperator):
    ...
    :param configure_batch_definition: A callable that returns a BatchDefinition to configure GX to read your data.
    ...
    :param expect: An Expectation or ExpectationSuite to validate against the Batch. Available Expectations can
        be found at https://greatexpectations.io/expectations.
    :param batch_parameters: dictionary that specifies a time-based Batch of data  to validate your Expectations against.
    ...
    :param context_type: accepts `ephemeral` or `cloud` to set the DataContext used by the Operator.
    ...
    :param result_format: control the verbosity of returned Validation Results. Possible values are
