...
class GXCloudConfig:
    """Configuration for connecting to GX Cloud."""
...
class GXCloudHook(BaseHook):
    ...
    :param gx_cloud_conn_id: name of the GX Cloud connection
    """
    ...
    def get_conn(self) -> GXCloudConfig:  # type: ignore[override]
        ...
        return GXCloudConfig(cloud_access_token=config.password, cloud_organization_id=config.login)
    ...
    def test_connection(self) -> tuple[bool, str]:
        """Test the connection to GX Cloud."""
        try:
