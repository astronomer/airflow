...
class AnthropicSessionBudgetExceeded(AnthropicAgentSessionError):
    ...
    but catchable on its own: a budget stop is a spend decision, not a fault, and usually
    wants different handling (alert, raise the ceiling, route to review) than a failed run.
    """
