...
This package is for the ``Human Interaction`` provider.
All classes for this package are included in the ``airflow.providers.interactive`` python package.

Installation
------------

You can install this package on top of an existing Airflow 3.1+ installation via
...
The minimum Apache Airflow version supported by this provider distribution is ``3.1.0``.
