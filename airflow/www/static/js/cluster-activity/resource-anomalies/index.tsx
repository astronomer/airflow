...
const ResourceAnomalies = () => {
  ...
  const { data: fetchedData, isError } = useResourceAnomaliesData(
    startDate,
    endDate
  );
      ...
      <Card w="100%">
        <CardHeader>
          <Flex alignItems="center">
            <Heading size="md">Resource Anomalies</Heading>
            <InfoTooltip
              label="Based on historical data around airflow resource."
              size={18}
            />
          </Flex>
        </CardHeader>
