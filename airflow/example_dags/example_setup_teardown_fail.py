...
# todo: importing dag from here adds the dag?


class EmptyFailOperator(BaseOperator):
    """Empty operator which always fails the task."""
...
with DAG(
    dag_id="example_setup_teardown_fail",
    ...
    fail_setup >> fail_normal_op >> fail_teardown
